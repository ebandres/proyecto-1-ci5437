...
{
  if( state->vars[ 0 ] == 0 && state->vars[ 1 ] == 1 && state->vars[ 2 ] == 2 && state->vars[ 3 ] == 3 && state->vars[ 4 ] == 0 && state->vars[ 5 ] == 0 && state->vars[ 6 ] == 6 && state->vars[ 7 ] == 7 && state->vars[ 8 ] == 0 && state->vars[ 9 ] == 0 && state->vars[ 10 ] == 0 && state->vars[ 11 ] == 0 && state->vars[ 12 ] == 0 && state->vars[ 13 ] == 0 && state->vars[ 14 ] == 0 && state->vars[ 15 ] == 0 ) {
    return 1;
  }
  return 0;
}

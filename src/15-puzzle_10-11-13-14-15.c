...
static const char *bwd_rule_name[ 48 ] = { "RULE_1", "RULE_2", "RULE_3", "RULE_4", "RULE_5", "RULE_6", "RULE_7", "RULE_8", "RULE_9", "RULE_10", "RULE_11", "RULE_12", "RULE_13", "RULE_14", "RULE_15", "RULE_16", "RULE_17", "RULE_18", "RULE_19", "RULE_20", "RULE_21", "RULE_22", "RULE_23", "RULE_24", "RULE_25", "RULE_26", "RULE_27", "RULE_28", "RULE_29", "RULE_30", "RULE_31", "RULE_32", "RULE_33", "RULE_34", "RULE_35", "RULE_36", "RULE_37", "RULE_38", "RULE_39", "RULE_40", "RULE_41", "RULE_42", "RULE_43", "RULE_44", "RULE_45", "RULE_46", "RULE_47", "RULE_48" };
...
{
  if( state->vars[ 0 ] == 0 && state->vars[ 1 ] == 0 && state->vars[ 2 ] == 0 && state->vars[ 3 ] == 0 && state->vars[ 4 ] == 0 && state->vars[ 5 ] == 0 && state->vars[ 6 ] == 0 && state->vars[ 7 ] == 0 && state->vars[ 8 ] == 0 && state->vars[ 9 ] == 0 && state->vars[ 10 ] == 10 && state->vars[ 11 ] == 11 && state->vars[ 12 ] == 0 && state->vars[ 13 ] == 13 && state->vars[ 14 ] == 14 && state->vars[ 15 ] == 15 ) {
    return 1;
  }
  return 0;
}

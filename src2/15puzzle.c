...
static const char *fwd_rule_name[ 48 ] = { "RIGHT", "BOT", "RIGHT", "BOT", "LEFT", "RIGHT", "BOT", "LEFT", "BOT", "LEFT", "TOP", "RIGHT", "BOT", "TOP", "RIGHT", "BOT", "LEFT", "TOP", "RIGHT", "BOT", "LEFT", "TOP", "BOT", "LEFT", "TOP", "RIGHT", "BOT", "TOP", "RIGHT", "BOT", "LEFT", "TOP", "RIGHT", "BOT", "LEFT", "TOP", "BOT", "LEFT", "TOP", "RIGHT", "TOP", "RIGHT", "LEFT", "TOP", "RIGHT", "LEFT", "TOP", "LEFT" };
#define get_fwd_rule_label( ruleid ) (fwd_rule_name[(ruleid)]) 
static const char *bwd_rule_name[ 48 ] = { "RIGHT", "BOT", "RIGHT", "BOT", "LEFT", "RIGHT", "BOT", "LEFT", "BOT", "LEFT", "TOP", "RIGHT", "BOT", "TOP", "RIGHT", "BOT", "LEFT", "TOP", "RIGHT", "BOT", "LEFT", "TOP", "BOT", "LEFT", "TOP", "RIGHT", "BOT", "TOP", "RIGHT", "BOT", "LEFT", "TOP", "RIGHT", "BOT", "LEFT", "TOP", "BOT", "LEFT", "TOP", "RIGHT", "TOP", "RIGHT", "LEFT", "TOP", "RIGHT", "LEFT", "TOP", "LEFT" };

...
void set_pdb(){
	FILE *f1 = fopen("absHanoi18d_1.pdb","r");
	FILE *f2 = fopen("absHanoi18d_2.pdb","r");

	pdb1 = read_state_map(f1);
	pdb2 = read_state_map(f2);

	abs1 = read_abstraction_from_file("absHanoi18d_1.abst");
   abs2 = read_abstraction_from_file("absHanoi18d_2.abst");
